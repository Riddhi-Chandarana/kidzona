...
public class Main5_4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main5_4);
        ...
        home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(Main5_4Activity.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
                    ...
                    if(view.getId()==R.id.tx5)
                    {
                        Thread mythread = new Thread(){
                            ...
                            public void run() {
                                try {
                                    sleep(1000);
                                    Intent intent = new Intent(getApplicationContext(), Main6_4Activity.class);
