...
public class Main5_2Activity extends AppCompatActivity {
    TextView tx1,tx2,tx3,tx4,tx5;
    MediaPlayer sound;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main5_2);
        ...
        home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(Main5_2Activity.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
                    ...
                    if(view.getId()==R.id.tx1)
                    {
                        Thread mythread = new Thread(){
                            ...
                            public void run() {
                                try {
                                    sleep(1000);
                                    Intent intent = new Intent(getApplicationContext(), Main6_2Activity.class);
