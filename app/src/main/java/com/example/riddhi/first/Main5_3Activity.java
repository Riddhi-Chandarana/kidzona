...
public class Main5_3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(Main5_3Activity.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
                    ...
                    if(view.getId()==R.id.tx2)
                    {
                        Thread mythread = new Thread(){
                            ...
                            public void run() {
                                try {
                                    sleep(1000);
                                    Intent intent = new Intent(getApplicationContext(), Main6_3Activity.class);
